...
class _WalletActionSheetState extends State<WalletActionSheet> {
  ...
  Future<void> _startWithdrawal() async {
    ...
    if (_amount > widget.currentBalance) {
      _snack('Solde insuffisant (${_fmt(widget.currentBalance)} FCFA)',
          Colors.red);
      return;
    }
  ...
  String _phoneHint() {
    switch (_operator) {
      case 'orange':
        return 'Ex: 07 00 00 00 00';
      case 'mtn':
        return 'Ex: 05 00 00 00 00';
      case 'moov':
        return 'Ex: 01 00 00 00 00';
      default:
        return 'Ex: 07 00 00 00 00';
    }
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (_withdrawStatus != null) _resultView() else _formView(),
          ],
        ),
      ),
    );
  ...
  Widget _formView() => Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _info(
              'L\'argent sera envoyé sur ce numéro après validation.', _kBlue),

          if (_amount > widget.currentBalance && _amount > 0) ...[
            const SizedBox(height: 8),
            _warning(
                'Montant supérieur à votre solde (${_fmt(widget.currentBalance)} FCFA)'),
          ],
          if (_errorMsg != null) ...[
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: selected ? _kBlue : Colors.grey.shade300),
        ),
  ...
  Widget _otherChip() => GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(10),
            border:
                Border.all(color: _useCustom ? _kBlue : Colors.grey.shade300),
          ),
          child: Text('Autre',
              style: GoogleFonts.urbanist(
                  fontWeight: FontWeight.bold,
  ...
  String _opLogo(String value) {
    switch (value) {
      case 'mtn':
        return 'assets/payment/mtn.png';
      case 'orange':
        return 'assets/payment/orange.png';
      case 'moov':
        return 'assets/payment/moov.png';
      default:
        return 'assets/payment/wave.png';
    }
  }
