...
class AzVoiceDictionary {
  ...
  static const List<String> knownTerms = [
    'Abengourou', 'Commerce', 'Château', 'Baoulékro', 'Cafétou', 'Plateau',
    'Pokoukro', 'Résidentiel', 'Administratif', 'Niablé', 'Amélékia',
    'Sankadiokro', 'Zinzenou', 'Yakassé-Feyassé', 'Aniassué', 'Kodjinan',
    'Zamaka', 'Assakra', 'Apprompronou',
    'Livraison', 'Courses', 'Wallet', 'Djassa', 'Immobilier', 'E-Kbine',
    'Boutique', 'Restaurant', 'Pharmacie', 'Boulangerie', 'Livreur', 'Colis',
    'Wave', 'MTN', 'Moov Money', 'Orange Money',
  ];
}
