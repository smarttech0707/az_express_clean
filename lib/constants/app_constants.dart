...
class StoragePaths {
  ...
  static String deliveryPhoto(String driverId, String orderId) => 'delivery_photos/$driverId/$orderId.jpg';
  ...
  static String ekbineProof(String orderId) => 'ekbine_proofs/$orderId/proof.jpg';
}
