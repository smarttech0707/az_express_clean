...
class FeexPayTransaction {
  ...
  static TxStatus _parseStatus(String? s) {
    switch (s) {
      case 'completed':  return TxStatus.completed;
      case 'failed':     return TxStatus.failed;
      case 'cancelled':  return TxStatus.cancelled;
      case 'error':      return TxStatus.error;
      default:           return TxStatus.pending;
    }
  }
