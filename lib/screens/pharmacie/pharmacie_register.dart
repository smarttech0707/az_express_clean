...
class _PharmacieRegisterState extends State<PharmacieRegister> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (!mounted) return;
      _snack('Demande envoyée ! L\'admin va valider votre pharmacie.',
          Colors.green);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            _field(
                _ownerCtrl, 'Votre nom complet *', Icons.person_outline, red),
            const SizedBox(height: 12),
            _field(
                _phoneCtrl, 'Numéro de téléphone *', Icons.phone_outlined, red,
                type: TextInputType.phone),
            const SizedBox(height: 20),
            _section('Votre pharmacie'),
            const SizedBox(height: 10),
            _field(_nameCtrl, 'Nom de la pharmacie *',
                Icons.local_pharmacy_outlined, red),
            const SizedBox(height: 12),
