...
class AdminRestaurantRequestsPage extends StatefulWidget {
  ...
  @override
  State<AdminRestaurantRequestsPage> createState() =>
      _AdminRestaurantRequestsPageState();
}

class _AdminRestaurantRequestsPageState
    extends State<AdminRestaurantRequestsPage>
  ...
  Future<void> _approve(String uid, Map<String, dynamic> data) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${data['restaurantName']} approuvé !'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Demandes Restaurateurs',
            style: GoogleFonts.urbanist(fontWeight: FontWeight.bold)),
