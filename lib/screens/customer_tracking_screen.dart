...
class _CustomerTrackingScreenState extends State<CustomerTrackingScreen>
  ...
  void initState() {
    ...
    _staleCheckTimer = Timer.periodic(
      ...
      (_) {
        if (mounted && _tracking.hasDriver) setState(() {});
      },
    );
  ...
  void _onSearchChanged() {
    ...
    _debounce = Timer(const Duration(milliseconds: 350), () async {
      final results = await PlacesSearchService.autocomplete(input);
          ...
          if (!_isConnected)
            Positioned(
              ...
              child: _WeakConnectionBanner(
                lastUpdate:
                    _tracking.hasDriver && _tracking.lastUpdateTime.year > 2000
            ...
            builder: (_, __) => Positioned(
              ...
              child: Column(children: [
                _FloatingBtn(
                  ...
                  bgColor:
                      _tracking.followDriver ? AppColors.primary : Colors.white,
                  iconColor:
                      _tracking.followDriver ? Colors.white : Colors.black87,
                  onTap: () {
...
class _WaitBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x22000000), blurRadius: 12, offset: Offset(0, 3))
          ],
        ),
        child: Row(
            mainAxisSize: MainAxisSize.min,
...
class _WeakConnectionBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final timeStr =
        lastUpdate != null ? DateFormat('HH:mm').format(lastUpdate!) : null;
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 9),
      decoration: BoxDecoration(
