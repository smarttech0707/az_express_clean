...
class EkOrder {
  ...
  final String? agentMomoNumber; // agent's MoMo number for this order's operator
  final String operator;       // orange / mtn / moov / wave
  final String serviceId;      // credit / mix / internet / transfer / momo_deposit / momo_withdrawal
  ...
  final String status;         // pending / assigned / awaiting_deposit / in_progress / proof_sent / completed / cancelled / disputed
