...
// ── Brands by category ─────────────────────────────────────────────────────────
const phonesBrands = [
  'Apple', 'Samsung', 'Xiaomi', 'Huawei', 'Tecno',
  'Infinix', 'Oppo', 'Vivo', 'Nokia', 'Google Pixel', 'Autre',
];
const tabletsBrands = [
  'Apple', 'Samsung', 'Lenovo', 'Huawei', 'Xiaomi', 'Autre',
];
const computersBrands = [
  'HP', 'Dell', 'Lenovo', 'Asus', 'Acer', 'MSI', 'Apple', 'Autre',
];
const accessoriesBrands = [
  'Apple', 'Samsung', 'Xiaomi', 'Anker', 'JBL', 'Sony',
  'Logitech', 'Baseus', 'Autre',
];

List<String> brandsForCategory(String cat) {
  switch (cat) {
    case 'tablets':     return tabletsBrands;
    case 'computers':   return computersBrands;
    case 'accessories': return accessoriesBrands;
    default:            return phonesBrands;
  }
}
...
String conditionLabel(String c) {
  switch (c) {
    ...
    case 'like_new': return 'Quasi neuf';
...
Color conditionColor(String c) {
  switch (c) {
    case 'new':      return const Color(0xFF4CAF50);
    case 'like_new': return const Color(0xFF2196F3);
...
const storageOptions = [
  '16 Go', '32 Go', '64 Go', '128 Go', '256 Go', '512 Go', '1 To',
];

// ── RAM options ───────────────────────────────────────────────────────────────
const ramOptions = ['2 Go', '3 Go', '4 Go', '6 Go', '8 Go', '12 Go', '16 Go', '32 Go'];

// ── Common colors ─────────────────────────────────────────────────────────────
const deviceColors = [
  'Noir', 'Blanc', 'Argent', 'Or', 'Bleu', 'Rouge',
  'Vert', 'Violet', 'Rose', 'Gris', 'Autre',
];

// ── Villes ────────────────────────────────────────────────────────────────────
const mpCities = [
  'Abengourou', 'Abidjan', 'Bouaké', 'Yamoussoukro', 'San Pedro',
