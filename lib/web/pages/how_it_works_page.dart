    ...
    return Container(
      ...
      child: Column(children: [
        Container(
          ...
          child: Text('GUIDE', style: GoogleFonts.inter(
            fontSize: 12, fontWeight: FontWeight.w700, color: kOrange, letterSpacing: 1.2)),
        ).animate().fadeIn(duration: 600.ms),
        const SizedBox(height: 20),
        Text('Comment ça marche ?', style: kDisplayStyle(ctx), textAlign: TextAlign.center,
        ).animate(delay: 200.ms).fadeIn(duration: 700.ms),
        const SizedBox(height: 16),
        Text('Tout ce que vous devez savoir pour utiliser AZ Express.',
...
class _TabHeader extends StatelessWidget {
  ...
  const _TabHeader({required this.icon, required this.color,
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(subtitle, style: GoogleFonts.inter(fontSize: 14, color: kTextMuted)),
      ]),
    ]);
  }
}
...
class _TimelineItem extends StatelessWidget {
  ...
  const _TimelineItem({required this.step, required this.index,
    required this.isLast, required this.reversed});
  ...
  Widget build(BuildContext context) {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [step.$2.withValues(alpha: 0.5), Colors.transparent],
                    ),
                  ),
                ),
            ],
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(step.$4, style: GoogleFonts.inter(
    ...
    ).animate(delay: (index * 100).ms).fadeIn(duration: 600.ms).slideX(begin: -0.1);
  }
}
...
class _FaqSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: hPad(context), vertical: 72),
      child: Column(children: [
        Text('Questions fréquentes', style: kH1Style(context), textAlign: TextAlign.center),
        const SizedBox(height: 48),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: _open ? kOrange.withValues(alpha: 0.4) : kDivider),
        ),
        child: Column(children: [
          Padding(
...
class _CtaSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: hPad(context), vertical: 72),
      child: Column(children: [
        Text('Prêt à commencer ?', style: kH1Style(context), textAlign: TextAlign.center),
        const SizedBox(height: 16),
        ...
        Wrap(
          ...
          children: [
            _Btn(label: '📱 Télécharger l\'App',
              onTap: () => launchUrl(Uri.parse('https://play.google.com')), filled: true),
            _Btn(label: '🛵 Devenir Livreur',
              onTap: () => context.go('/livreurs'), filled: false),
          ],
        ),
      ]),
    );
...
class _BtnState extends State<_Btn> {
  ...
  Widget build(BuildContext context) => MouseRegion(
    ...
    child: GestureDetector(
      onTap: widget.onTap,
      child: AnimatedScale(scale: _h ? 1.04 : 1.0, duration: 150.ms,
        child: Container(
