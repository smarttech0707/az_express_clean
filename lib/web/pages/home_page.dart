...
class _HeroSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      constraints:
          BoxConstraints(minHeight: MediaQuery.of(context).size.height - 72),
      ...
      child: Stack(
        children: [
          ...
          Positioned(
              ...
              right: -80,
              child: _GlowCircle(
                  size: 400, color: kOrange.withValues(alpha: 0.06))),
          Positioned(
              bottom: 0,
              left: -120,
              child:
                  _GlowCircle(size: 500, color: kBlue.withValues(alpha: 0.07))),
          Positioned(
              top: 200,
              left:
                  '20%'.isEmpty ? 100 : MediaQuery.of(context).size.width * 0.4,
              child: _GlowCircle(
                  size: 200, color: kOrange.withValues(alpha: 0.04))),
          ...
          text: TextSpan(
            ...
            children: [
              ...
              TextSpan(
                text: 'Instantanés',
                style: kDisplayStyle(context)
                    .copyWith(color: kWhite.withValues(alpha: 0.6)),
              ),
            ],
          ),
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: _hover ? kOrange.withValues(alpha: 0.4) : kDivider),
          ),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              Column(
                ...
                children: [
                  Text(widget.subtitle,
                      style:
                          GoogleFonts.inter(fontSize: 10, color: kTextMuted)),
                  Text(widget.title,
                      style: GoogleFonts.inter(
                        fontSize: 14,
                        fontWeight: FontWeight.w700,
...
class _WalletSection extends StatelessWidget {
  static const _features = [
    (
      ...
      kOrange,
      'Recharger',
      'Wave, MTN Money, Orange Money, Moov Money.'
    ),
    (
      Icons.send_rounded,
      kBlue,
      'Transférer',
      'Envoyez de l\'argent à un autre utilisateur AZ Express.'
    ),
    (
      Icons.receipt_long_rounded,
      kSuccess,
      'Historique',
      'Consultez toutes vos transactions en temps réel.'
    ),
    (
      Icons.shopping_bag_rounded,
      Color(0xFF9C27B0),
      'Payer commande',
      'Utilisez votre solde pour régler vos commandes.'
    ),
  ];
      ...
      child: Column(
        children: [
          const _SectionHeader(
            ...
            subtitle:
                'Rechargez, transférez et payez directement depuis l\'app.',
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Wrap(
        ...
        runSpacing: 20,
        children:
            _stats.map((s) => _StatItem(value: s.$1, label: s.$2)).toList(),
      ),
    );
  }
}
...
class _ServicesSection extends StatelessWidget {
  static const _services = [
    (
      ...
      'Livraison Express',
      'Colis livrés en 30 min chrono.',
      kOrange
    ),
    (
      Icons.bakery_dining_rounded,
      'Boulangerie & Café',
      'Viennoiseries fraîches & gâteaux personnalisés.',
      Color(0xFF795548)
    ),
    (
      Icons.restaurant_menu_rounded,
      'Restaurants',
      'Vos plats préférés livrés chauds.',
      Color(0xFFE91E63)
    ),
    (
      Icons.local_pharmacy_rounded,
      'Pharmacie de garde',
      'Médicaments 24h/24, 7j/7.',
      kSuccess
    ),
    (
      Icons.storefront_rounded,
      'Boutique',
      'Achetez chez les commerçants locaux.',
      Color(0xFF9C27B0)
    ),
    (
      Icons.shopping_bag_rounded,
      'Courses Libres',
      'Un livreur fait vos courses à votre place.',
      Color(0xFF3F51B5)
    ),
    (
      Icons.home_rounded,
      'Immobilier',
      'Maisons & résidences meublées à Abengourou.',
      Color(0xFF00BCD4)
    ),
    (
      Icons.local_taxi_rounded,
      'Taxi & Tricycle',
      'Taxi de nuit & location de tricycle.',
      Color(0xFFFF5722)
    ),
  ];
...
class _HowItWorksSection extends StatelessWidget {
  static const _steps = [
    (
      ...
      'Commandez',
      'Choisissez votre service et passez commande en quelques secondes.',
      kOrange
    ),
    (
      '2',
      ...
      'Acceptation',
      'Un livreur proche accepte et prend en charge votre commande.',
      kBlue
    ),
    (
      '3',
    ...
    (
      ...
      'Livraison',
      'Recevez votre commande et notez votre expérience.',
      Color(0xFF9C27B0)
    ),
  ];
      ...
      child: Column(
        children: [
          const _SectionHeader(
            ...
            subtitle:
                '4 étapes pour recevoir ce que vous voulez, où vous êtes.',
          ),
  ...
  Widget _downloadText(BuildContext ctx) {
    return Column(
      ...
      children: [
        ...
        Text(
            'Ton wallet, tes commandes, ta boutique.\nGratuit sur Android et iOS.',
            style: GoogleFonts.inter(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
                color: _hover ? kOrange.withValues(alpha: 0.5) : kDivider),
          ),
          child: Row(
            children: [
...
class _MerchantsSection extends StatelessWidget {
  static const _perks = [
    (
      ...
      'Touchez des milliers de clients supplémentaires.'
    ),
    (
      Icons.dashboard_rounded,
      'Dashboard complet',
      'Gérez vos commandes, stocks et revenus en temps réel.'
    ),
    (
      Icons.payments_rounded,
      'Paiements sécurisés',
      'Wave, MTN Money, Orange Money et Moov Money via FeexPay.'
    ),
    (
      ...
      child: Column(
        children: [
          const _SectionHeader(
            ...
            subtitle:
                'Rejoignez plus de 200 commerçants qui font confiance à AZ Express.',
          ),
          const SizedBox(height: 48),
          GridView.builder(
            shrinkWrap: true,
