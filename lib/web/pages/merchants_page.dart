    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Rejoignez la plateforme N°1 de livraison en Côte d\'Ivoire et\ntouchez des milliers de nouveaux clients chaque jour.',
            style:
...
class _HowToJoin extends StatelessWidget {
  static const _steps = [
    ...
    (
      ...
      'Validation',
      'Notre équipe valide votre dossier sous 24h.'
    ),
    (
      '3',
      Icons.rocket_launch_rounded,
      'Mise en ligne',
      'Votre boutique est visible par tous nos clients.'
    ),
    (
      '4',
      Icons.trending_up_rounded,
      'Croissance',
      'Recevez commandes, paiements et statistiques.'
    ),
  ];
      ...
      child: Column(children: [
        Container(
          ...
          decoration: const BoxDecoration(
              shape: BoxShape.circle, gradient: kOrangeGradient),
          child: Center(
              child: Text(s.$1,
                  style: GoogleFonts.inter(
                      fontSize: 20,
        ...
        Text(s.$4,
            style:
                GoogleFonts.inter(fontSize: 13, color: kTextMuted, height: 1.6),
            textAlign: TextAlign.center),
      ]),
    );
  }
  ...
  Widget _successView() {
    return Column(children: [
      Container(
        ...
        height: 80,
        decoration: BoxDecoration(
            shape: BoxShape.circle, color: kSuccess.withValues(alpha: 0.1)),
        child:
      ...
      Text(
          'Notre équipe commerciale vous contactera dans les 24 heures pour finaliser votre inscription.',
          style:
  ...
  Widget _formView() {
    return Form(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: 16),
        _field(_phoneCtrl, 'Téléphone (WhatsApp de préférence)',
            Icons.phone_rounded,
