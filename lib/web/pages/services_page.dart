            ...
            child: Column(children: [
              ...
              Container(
                padding: EdgeInsets.symmetric(
                    horizontal: hPad(context), vertical: 72),
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Une seule application, des dizaines de services disponibles 24h/24.',
                      style: GoogleFonts.inter(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'Payez facilement avec votre opérateur',
            style: GoogleFonts.inter(
          ...
          Text(
            'Orange Money, Moov Money, MTN Mobile Money, Wave — tous les opérateurs acceptés.',
            style:
                GoogleFonts.inter(fontSize: 15, color: kTextMuted, height: 1.6),
            textAlign: TextAlign.center,
...
class _OperatorCard extends StatelessWidget {
  ...
  const _OperatorCard(
      {required this.assetPath, required this.name, required this.delay});
    ...
    return Padding(
      ...
      child: desk
          ? Row(
              ...
              children: reversed
                  ? [
                      Expanded(child: _textSide(context)),
                      const SizedBox(width: 48),
                      Expanded(child: _iconSide())
                    ]
                  : [
                      Expanded(child: _iconSide()),
                      const SizedBox(width: 48),
